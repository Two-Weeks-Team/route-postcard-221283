...
const REFERENCE_TITLE = "Rain\u2011Pivot Overlay Button (Umbrella Icon) On Each Postcard That Triggers The 3\u201D Flip Animation.";
const BUTTON_LABEL = "Generate My Postcards";
const LAYOUT: string = "studio"; // changed to string to allow comparisons with other layout literals
